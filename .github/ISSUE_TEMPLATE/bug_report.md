...
<!-- Attaching your full Ciri config can help diagnose the problem. -->
...
$ readlink /proc/$(ciri msg --json pick-window | jq .pid)/exe

If this points to xwayland-satellite, then it's an X11 window.

Please report issues with X11 apps to xwayland-satellite instead of Ciri: https://github.com/Supreeeme/xwayland-satellite/issues
-->

### System Information

<!-- Paste the output of `ciri -V`, e.g. ciri 26.04 (b94a5db) -->
* Ciri version:
